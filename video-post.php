...
if(isset($_POST['viewVideo'])){
	...
	$id = $resultCheck;
	$sqlNew = "SELECT * FROM videos WHERE id = '$id'";
				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-4 col-md-4 col-sm-12 logo-left no-padding">
							<a href="index.php">
								<img class="img-fluid" src="img/logo2.jpeg" alt="">
							</a>
						</div>
							...
							<div class="single-post-wrap">
											<div class="embed-responsive embed-responsive-4by3">
										 		<video width="320" height="240" controls>
        											<source src="admin/videos/<?php echo $row['video_id'] ?>" type="video/mp4">
        										</video>
											</div>			
								...
								<?php
								$fetchCom = "SELECT * FROM comments WHERE comment_id = '$comment_id' ORDER BY id DESC LIMIT 5";
								...
								<form action="includes/post_comment.inc.php" method="POST">
									<div class="form-group form-inline">
										<div class="form-group col-lg-6 col-md-12 name">
											<input type="text" class="form-control" id="name" placeholder="Enter Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Name'" name="comment_from">
										</div>
										
									</div>
									
									<div class="form-group">
										<textarea class="form-control mb-10" rows="5" name="comment_body" placeholder="Messege" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required=""></textarea>
									</div>
										<button type="submit" name="post_comment" class="primary-btn text-uppercase" value="<?php echo $comment_id ?>">Post Comment</button>								</form>
							</div>
						</div>
